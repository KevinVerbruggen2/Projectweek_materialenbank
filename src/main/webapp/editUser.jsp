...
<div class="container">
  ...
  <main class="p-3 bg-light">
    ...
    <form class="widthform" method="post" action="Controller?command=EditUserExecute&id=${param.get("id")}" novalidate>
      <p class="form-group">
      <div>
      ...
      <p class="form-group">
        ...
        <input class="form-control input-md" type="text" name="email" id="email" value="<c:out value='${emailPreviousValue}'/>" required >
      </p>
      <p class="form-group">
