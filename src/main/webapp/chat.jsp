...
<div class="container">
  ...
  <main class="p-3 bg-light" style="min-height: 100%">
    ...
    <div>
      ...
      <form method="post" action="Controller?command=SendMessage" enctype='multipart/form-data' novalidate="novalidate">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="message..." name="newMessage" aria-describedby="button-addon2">
