...
<div class="container">
    ...
    <main class="p-3 bg-light">
        ...
        <h2>Register</h2>
        <form class="widthform" method="post" action="Controller?command=RegisterUser" novalidate>
            <p class="form-group">
            ...
            <p class="form-group">
                ...
                <input class="form-control input-md" type="text" name="email" id="emailregister2" value="<c:out value='${emailPreviousValueRegister}'/>" required >
            </p>
            <p class="form-group">
