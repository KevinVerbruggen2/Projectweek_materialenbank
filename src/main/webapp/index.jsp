    ...
    <main class="p-3 bg-light">
        ...
        <c:choose>
            <c:when test="${empty user}">
                ...
                <h2>Login</h2>
                <form class="widthform" method="post" action="Controller?command=Login" novalidate>
                    <p class="form-group">
                        <label for="email">Email: </label><input class="form-control input-md" type="text" name="email" id="email" value="<c:out value='${emailPreviousValue}'/>" required >
                    </p>
                    <p class="form-group">
